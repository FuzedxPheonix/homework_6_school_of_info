...
def personal_map(user_function, new_lst):
    mapped = []
    for item in new_lst:
        mapped.append(user_function(item))
...
programmers = [Student(lst[0], lst[1], lst[2]) for lst in student_tups_list]
...
names_and_productivities = [(x.name,y) for x, y in zip(programmers, prod_list)]
## [PROBLEM 8]
print("\n\n***** Problem 8 *****")
